(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("spademo", [], factory);
	else if(typeof exports === 'object')
		exports["spademo"] = factory();
	else
		root["spademo"] = factory();
...
exports.ProxyService = undefined;

var _proxyservice = __webpack_require__(135);

var _proxyservice2 = _interopRequireDefault(_proxyservice);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.ProxyService = _proxyservice2.default;
...
var _qs = __webpack_require__(359);
...
var ProxyService = function () {
  function ProxyService(proxyUrl, appName) {
  ...
  _createClass(ProxyService, [{
    ...
    value: function load(callback) {
      console.log('load this app ' + this._appName);
      var ticket = null;

      if (typeof window !== 'undefined') {
        var myStorage = window.localStorage;

        ticket = myStorage.getItem('INN_user_session_ticket');
      }

      var url = this._proxyUrl + '/load/api/' + this._appName;

      if (ticket !== null) {
        url = url + '?userticket=' + ticket;
      }

      _axios2.default.get(url).then(function (response) {
        console.log(response.data);
        if (callback) {
          callback(response.data.secret, response.data.userticket);
        }
      }).catch(function (err) {
        console.log(err);
      });
    ...
    key: 'getUserToken',
    value: function getUserToken(secret, userticket, callback) {
      console.log('get usertoken with secret ' + secret + ' ' + userticket);

      var url = this._proxyUrl + '/api/' + secret + '/get_token_from_ticket/' + this.userticket;
    ...
    key: 'authenticate',
    value: function authenticate(secret, username, password, callback) {
      console.log('get usertoken with credential ' + username + ' ' + password);
      var url = this._proxyUrl + '/api/' + secret + '/authenticate_user/';

      _axios2.default.post(url, _qs2.default.stringify({
        username: username,
        password: password
    ...
    value: function unload() {
      ...
      console.log('unload this app ' + this._secret);
    }
  }, {
    key: 'appName',
    get: function get() {
