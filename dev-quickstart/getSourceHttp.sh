...
git clone https://github.com/Cantara/Whydah-Admin-SDK.git
...
git clone https://github.com/Cantara/Whydah-SPAProxyService.git
git clone https://github.com/Cantara/Whydah-OAuth2Service.git
